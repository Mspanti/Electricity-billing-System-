...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup(){
        ...
        ImageIcon boyIcon = new ImageIcon(ClassLoader.getSystemResource("icon/boy1.png"));
        Image boyImg = boyIcon.getImage().getScaledInstance(520,520,Image.SCALE_DEFAULT);
